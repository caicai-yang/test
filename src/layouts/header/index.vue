<template>
  <div
    ...
    :class="{ 'standard-blue-header-layout': appStore.isStandardTheme }"
  >
    ...
    <a-card
      class="right-wrapper"
      :class="{ 'standard-blue-wrapper': appStore.isStandardTheme }"
...
<style scoped lang="less">
  .vaw-header-layout {
    ...
    .right-wrapper {
      ...
      align-items: center;
      &.standard-blue-wrapper {
        background-color: transparent;
        :deep(.arco-icon) {
          color: #fff;
        }
        :deep(.action-item):hover {
          background-color: var(--standard-blue-active);
        }
      }
      .avatar-wrapper {
        display: flex;
