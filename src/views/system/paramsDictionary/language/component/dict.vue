...
<script setup name="DictLanguage" lang="ts">
  import { ref, onMounted, computed } from 'vue'
  // import { Message } from '@arco-design/web-vue'
  import { getLanguageList } from '@/api/system/language'
  import { getTableList, getLabelList } from '@/api/system/dictionary'
  ...
  // 点击行
  function handleCellClick(record: { id: number; code: string; enabled: number }) {
    if (dictionaryCode.value === record.code) {
  ...
  function getDetailList() {
    ...
    getLabelList({ ...queryParams.value, dictionaryCode: dictionaryCode.value }).then(res => {
